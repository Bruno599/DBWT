        ...
        <div class="container border-bottom border-dark">
            <div class="row align-items-baseline">
                ...
                <div class="pr-2 pl-2 col-1 text-right ">
                    <?php
                    if ($_SERVER['REQUEST_URI'] == "/DBWT/M2/Start.php") {
                        echo "<a>Start</a>";
                    }
                    else {
                ...
                <div class="pr-2 pl-2 col-1 border-left border-dark text-center">
                    <?php
                    if ($_SERVER['REQUEST_URI'] == "/DBWT/M2/Produkte.php") {
                        echo "<a>Mahlzeiten</a>";
                    }
                    else {
                        echo"<a class='fh_color' href='Produkte.php'>Mahlzeiten</a>";
                    }
                    ?>
                </div>
                <div class="pr-2 pl-2 col-1 border-left border-dark text-center">
                    <?php
                    if ($_SERVER['REQUEST_URI'] == "/DBWT/M2/Bestellung.php") {
                        echo "<a>Bestellung</a>";
                    }
                    else {
