...
function insert_student($remoteConnection){
    $query_student = "INSERT INTO Studenten (Nummer, Studiengang, Matrikelnummer) VALUES (LAST_INSERT_ID(),'".$_POST['Studiengang']."','".$_POST['Matrikelnummer']."')";
    $result_student = mysqli_query($remoteConnection, $query_student);
    if(mysqli_error($remoteConnection)){
        $GLOBALS['Error'][] = "Matrikelnummer oder Studiengang falsch";
        return false;
    }
    return true;
}
